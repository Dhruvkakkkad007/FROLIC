            ...
            {type === 'select' ? (
                <div className="relative group">
                    <select
                        ...
                        value={value}
                        onChange={onChange}
                        className={`${baseClasses} ${borderClasses} appearance-none cursor-pointer pr-10`}
                    >
                    ...
                    <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-gray-400 group-focus-within:text-primary transition-colors">
                ...
                <textarea
                    ...
                    rows="4"
                    className={`${baseClasses} ${borderClasses} resize-none focus:ring-opacity-50`}
                />
            ) : (
                <input
                    id={name}
                    ...
                    onChange={onChange}
                    placeholder={placeholder}
                    className={`${baseClasses} ${borderClasses} focus:ring-opacity-50`}
                />
            )}
